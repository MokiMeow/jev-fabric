...
| [Evidence](../evidence/README.md) | reproducibility and claim labels |
| [API reference](../reference/api.md) | packages and trusted programmatic integrations |
| [CLI reference](../reference/cli.md) | offline commands and explicit live controls |
| [MCP reference](../reference/mcp.md) | five advisory tools and transport lifecycle |
