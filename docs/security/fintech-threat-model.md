...
| High hypothesis | stale, future-dated, or substituted note is replayed | trusted runtime clock, exact observation/expiry equation, source/note hashes, and a domain-separated envelope hash committed to cache and receipt identity without provider egress | authenticate source timestamps and retain ingestion provenance |
