...
path also binds one neutral proposed claim to an exact filing excerpt and asks
a focused citation-support question. It can only record an observation, while
an invalid execution boundary is denied before a provider call.
